...
public static class ErrorMessage
{
    ...
    public const string LoadOtherVideoFailed = "Unable to load other video. Please try again.";
    public const string NoRelatedVideos = "There is no other video available.";
}
